...
if ((navigator.userAgent.indexOf('iPhone') > 0 && navigator.userAgent.indexOf('iPad') == -1) || navigator.userAgent.indexOf('iPod') > 0 || navigator.userAgent.indexOf('Android') > 0) {
    $.sublime_slideshow({
        src:[
            {url:"img/FirstLook Features Screenshots/FirstLook_CreepCreep_VALORANT.jpg"},
            {url:"img/FirstLook Features Screenshots/FirstLook_Smoke_VALORANT.jpg"},
			{url:"img/FirstLook Features Screenshots/Reveal_Window_VALORANT.jpg"}
            ],
            duration:   5,
            fade:       1,
            scaling:    false,
